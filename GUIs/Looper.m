...
global Lstate setupDefault

[file, path] = uigetfile(fullfile(setupDefault.loopParamRoot,'*.loop'),'Load looper state');
...
[file, path] = uiputfile(fullfile(setupDefault.loopParamRoot,'*.loop'),'Save as');
...
% --- Executes on button press in block1.
function block1_Callback(hObject, eventdata, handles)
% hObject    handle to block1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of block1

if get(hObject,'Value')
    %need to make sure that at least one parameter is not selected as blocked,
    %only taking into account existing parameters
    pstring{1}=get(handles.symbol1,'String');
    pstring{2}=get(handles.symbol2,'String');
    pstring{3}=get(handles.symbol3,'String');
    pstring{4}=get(handles.symbol4,'String');
    pstring{5}=get(handles.symbol5,'String');
    
    blockval(1)=get(handles.block1,'Value');
    blockval(2)=get(handles.block2,'Value');
    blockval(3)=get(handles.block3,'Value');
    blockval(4)=get(handles.block4,'Value');
    blockval(5)=get(handles.block5,'Value');
    
    bout=[];
    for i=1:5
        if ~isempty(pstring{i})
...
% --- Executes on button press in block2.
function block2_Callback(hObject, eventdata, handles)
% hObject    handle to block2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of block2
if get(hObject,'Value')
    %need to make sure that at least one parameter is not selected as blocked,
    %only taking into account existing parameters
    pstring{1}=get(handles.symbol1,'String');
...
% --- Executes on button press in block3.
function block3_Callback(hObject, eventdata, handles)
% hObject    handle to block3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of block3
if get(hObject,'Value')
    %need to make sure that at least one parameter is not selected as blocked,
    %only taking into account existing parameters
    pstring{1}=get(handles.symbol1,'String');
...
% --- Executes on button press in block4.
function block4_Callback(hObject, eventdata, handles)
% hObject    handle to block4 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of block4
if get(hObject,'Value')
    %need to make sure that at least one parameter is not selected as blocked,
    %only taking into account existing parameters
    pstring{1}=get(handles.symbol1,'String');
...
% --- Executes on button press in block5.
function block5_Callback(hObject, eventdata, handles)
% hObject    handle to block5 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of block5
if get(hObject,'Value')
    %need to make sure that at least one parameter is not selected as blocked,
    %only taking into account existing parameters
    pstring{1}=get(handles.symbol1,'String');
