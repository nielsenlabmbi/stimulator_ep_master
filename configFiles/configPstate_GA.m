...
Pstate.param{8} = {'stimpath'      'string'     '/Volumes/NielsenHome/Matlab/GA/projectTetrGA/stim/'       1                ''};
...
Pstate.param{18} = {'maskcolor'      'float'   0.5       0                ''};
Pstate.param{19} = {'background'      'float'   0       0                ''};
