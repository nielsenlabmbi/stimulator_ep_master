...
Pstate.param{13} = {'min_ori'         'int'        0       0                'deg'};
Pstate.param{14} = {'orirange'         'int'        360       0                'deg'};
Pstate.param{15} = {'n_ori'    'int'   16       0                ''};

Pstate.param{16} = {'min_sf'   'float'   0.125       0                'c/deg'};
Pstate.param{17} = {'max_sf'   'float'   0.125       0                'c/deg'};
Pstate.param{18} = {'n_sfreq' 'int'   1       0             ''};
Pstate.param{19} = {'sf_domain'   'string'   'log'       0                ''};

Pstate.param{20} = {'n_phase'   'int'   4       0                ''};

Pstate.param{21} = {'h_per'      'int'   40       0                'frames'};
Pstate.param{22} = {'blankProb'    'float'   0.05       0                ''};

Pstate.param{23} = {'s_profile'   'string'   'sin'       0                ''};
Pstate.param{24} = {'s_duty'      'float'   0.5       0                ''};
Pstate.param{25} = {'drift'    'int'   1         0                 'binary'};
Pstate.param{26} = {'t_period'    'int'       20       0                'frames'};

Pstate.param{27} = {'rseed'    'int'   1       0                ''};

Pstate.param{28} = {'Leye_bit'    'int'   1       0                ''};
Pstate.param{29} = {'Reye_bit'    'int'   1       0                ''};